...
function RightPanel() {
  ...
  // ONLY real processor subsystems.
  const subsystems = [
    "CPU", 
    "Register File", 
    "ECC Decoder", 
...
function Scene() {
  return (
    <>
      ...
      <spotLight position={[-5, 5, 5]} angle={0.5} penumbra={1} intensity={0.5} color="#3b82f6" />
...
export default function Dashboard() {
  return (
    <DashboardProvider>
      <div className="w-screen h-screen overflow-hidden bg-black bg-grid-pattern text-white relative font-sans">
        {/* Faint radial gradient to focus center */}
